...
DEGRADE_NAMESPACES: dict[str, str] = {
    ...
    "m5.golden_write_gate": "workflows/writing/m5_quality_gate.py",
    "m5.l1_block": "workflows/writing/m5_write_chapter.py",
    "m5.l1_trace": "workflows/writing/m5_write_chapter.py",
    "m5.quality_gate.d_merge": "workflows/writing/m5_quality_gate.py",
    "m5.quality_gate.d_missing": "workflows/writing/m5_quality_gate.py",
    "m5.quality_gate.parse": "workflows/writing/m5_quality_gate.py",
