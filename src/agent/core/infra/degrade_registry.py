...
DEGRADE_NAMESPACES: dict[str, str] = {
    ...
    "autowire.plan_critic": "workflows/pipeline/batch_replan.py",
    "autowire.subline_contract": "workflows/pipeline/batch_replan.py",
    ...
    "design_brief.carry": "core/story/design_brief.py",
    ...
    "rewrite.contract": "core/quality/rewrite/feedback_rewriter.py",
    "rewrite.expand": "core/quality/rewrite/feedback_rewriter.py",
    "rewrite.noop": "core/quality/rewrite/feedback_rewriter.py",
    ...
    "subline_contract.empty": "workflows/pipeline/subline_contract.py",
    "subline_contract.generate": "workflows/pipeline/subline_contract.py",
    "subline_contract.partial": "workflows/pipeline/subline_contract.py",
    "subline_contract.read": "workflows/pipeline/subline_contract.py",
    "subline_contract.thin_section": "workflows/pipeline/subline_contract.py",
