...
# ============================================================
# L2 生成残留硬污染（2026-09-14 框架化：定义下沉 core 层，本处 re-export 保持兼容）
# 纯函数实现见 agent/core/story/text_hygiene.py——guardrails（core 层）与
# 全部写改路径（agentic/m5/rewrite/paragraph_rewriter）统一消费同一份定义，
# 杜绝「一个路径修了、其他路径漏了」（灵荒薪传 ch001 双标题 + 预告泄漏复盘）。
# ============================================================
from agent.core.story.text_hygiene import (  # noqa: F401 - re-export 保持既有 import 兼容
