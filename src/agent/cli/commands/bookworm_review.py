...
def bookworm_review(
    ...
    from agent.workflows.evaluation.m15_bookworm import BookwormInput, BookwormSkill
    ...
    if skill is None:
        ...
        skill = registry.load_builtin("bookworm", llm=create_gateway(), console=console)
    ...
    if compare_with:
        ...
        if not old_file.exists():
            ...
            from agent.workflows.evaluation.m15_bookworm import BookwormIssue, BookwormReview
