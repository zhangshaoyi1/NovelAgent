...
5. 故事简介要有钩子，能吸引读者点开
6. 若用户消息中给出【参考境界体系】，这是题材包模板提供的参考（不是硬性约束）：power_system 与 golden_finger 的成长曲线应尽量沿用其中等级/境界名称，保持全书一套体系；若【故事核心】与参考体系冲突，以作者的故事核心为准，并在 power_system 开头用一句话说明替换了哪些参考等级
7. golden_finger 的成长曲线中出现的每一个境界/等级名，都必须能在【参考境界体系】或【故事核心】中找到出处，禁止混入第三套体系名
...
{% raw %}{
  ...
  "power_system": "力量/规则体系描述，200-300字；等级/境界名称必须沿用【参考境界体系】（若已给出）或【故事核心】中作者指定的体系，不得自创",
